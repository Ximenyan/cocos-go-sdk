...
func Sign(msg []byte, seckey []byte, ndata int) ([]byte, error) {
	if len(msg) != 32 {
	...
	var (
		...
		ndata_p   = unsafe.Pointer(&ndata)
		noncefunc = C.secp256k1_nonce_function_rfc6979
		sigstruct C.secp256k1_ecdsa_recoverable_signature
	)
	if C.secp256k1_ecdsa_sign_recoverable(context, &sigstruct, msgdata, seckeydata, noncefunc, ndata_p) == 0 {
